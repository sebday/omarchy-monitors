...
function pinTrayToInner(entries, section) {
  ...
  for (var i = 0; i < values.length; i++) {
    ...
    // Only pin the built-in tray. evo.tray (and other clones) keep their
    // shell.json position so drag-reorder and layout order stick.
    if (id === "omarchy.tray") trayEntry = values[i]
